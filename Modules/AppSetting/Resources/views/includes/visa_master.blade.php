    ...
    <div class="row form-md-line-input">
        ...
        <div class="col-md-9">
            <label class="switch switch-text switch-primary-outline-alt">
                <input type="checkbox" name="visa_master_enable" class="switch-input" {{ (config('payment.visa_master.enable')) ? 'checked' : ''}}>
...
<div class="card-body">
    <div class="form-group row form-md-line-input form-md-floating-label">
        ...
        <input type="text" value="{{ config('payment.visa_master.version') }}" id="visa_master_version" name="visa_master_version" class="form-control col-md-9">
    </div>
    <div class="form-group row form-md-line-input form-md-floating-label">
        <label class="col-md-3" for="visa_master_currency">Currency</label>

        <input type="text" value="{{ config('payment.visa_master.currency') }}" id="visa_master_currency" name="visa_master_currency" class="form-control col-md-9">
    </div>
    <div class="form-group row form-md-line-input form-md-floating-label">
        <label class="col-md-3" for="visa_master_hash_key">Hash Secret Key</label>

        <input type="text" value="{{ config('payment.visa_master.hash_key') }}" id="visa_master_hash_key" name="visa_master_hash_key" class="form-control col-md-9">
    </div>
    <div class="form-group row form-md-line-input form-md-floating-label">
        <label class="col-md-3" for="visa_master_merchant_id">Merchant ID</label>

        <input type="text" value="{{ config('payment.visa_master.merchant_id') }}" id="visa_master_merchant_id" name="visa_master_merchant_id" class="form-control col-md-9">
    </div>
    <div class="form-group row form-md-line-input form-md-floating-label">
        <label class="col-md-3" for="visa_master_payment_url">Payment URL</label>

        <input type="text" value="{{ config('payment.visa_master.payment_url') }}"  id="visa_master_payment_url" name="visa_master_payment_url" class="form-control col-md-9">
    </div>
    <div class="form-group row form-md-line-input form-md-floating-label">
        <label class="col-md-3" for="visa_master_frontend_url">Frontend URL</label>

        <input type="text" value="{{ config('payment.visa_master.frontend_url') }}" disabled="disabled"  id="visa_master_frontend_url" name="visa_master_frontend_url" class="form-control col-md-9">
    </div>
    <div class="form-group row form-md-line-input form-md-floating-label">
        <label class="col-md-3" for="visa_master_backend_url">Backend URL</label>

        <input type="text" value="{{ config('payment.visa_master.backend_url') }}"  disabled="disabled" id="visa_master_backend_url" name="visa_master_backend_url" class="form-control col-md-9">
    </div>
    ...
    <div class="form-group row form-md-line-input form-md-floating-label">
            ...
            <input type="text" value="{{ config('payment.visa_master.charge') }}" id="visa_master_charge" name="visa_master_charge" class="form-control col-md-9">
    </div>
</div>