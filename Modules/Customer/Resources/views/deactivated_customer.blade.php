...
@section ('title', app_name() . ' | ' . __('customer::labels.backend.customer.deactivated'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('customer::labels.backend.customer.management') }} <small class="text-muted">{{ __('customer::labels.backend.customer.deactivated') }}</small>
                </h4>
            </div><!--col-->
